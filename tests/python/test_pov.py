...
from projecteuler.pov import Tree
...
def test_find_node1():
    ...
    assert tree.__find_node__("kid-0") == ["grandparent", "parent", "x", "kid-0"]
    assert tree.__find_node__("cousin-0") == ["grandparent", "uncle", "cousin-0"]
...
def test_find_node2():
    ...
    assert tree.__find_node__("") == []
    assert tree.__find_node__("x") == ["parent", "x"]
